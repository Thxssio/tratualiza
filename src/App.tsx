            ...
            >
              ...
              <div className="relative z-10 rounded-[2rem] bg-gradient-to-br from-amber-500/20 via-slate-800/40 to-slate-950/70 p-[1px] shadow-[0_25px_80px_rgba(0,0,0,0.55)]">
                <div className="relative aspect-[4/5] overflow-hidden rounded-[calc(2rem-1px)] border border-white/8 bg-[linear-gradient(180deg,rgba(7,18,36,0.98)_0%,rgba(2,6,23,1)_100%)]">
                  ...
                  <div className="absolute left-6 top-6 z-20 inline-flex items-center gap-2 rounded-full border border-amber-400/20 bg-slate-950/70 px-4 py-2 text-xs font-medium uppercase tracking-[0.24em] text-amber-100 backdrop-blur-md">
                    <Sparkles className="h-4 w-4 animate-pulse text-amber-400" />
                    <span>Equipe Especialista</span>
                  </div>

                  <div className="absolute right-6 top-6 z-20 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-[11px] font-medium tracking-[0.22em] text-slate-300 backdrop-blur-md">
                    TR ATUALIZA
                  </div>
